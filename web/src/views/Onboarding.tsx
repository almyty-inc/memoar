  ...
  return (
    <div className="auth-page">
      <section className="auth-card">
        ...
        {/*
          A "Remember me" checkbox nothing read, a "Forgot password?" button
          with no handler and no endpoint behind it, and "Create an archive",
          which also did nothing. Signing in with GitHub or Google is how an
          archive comes to exist — the callback creates the account on first
          use — so that is what it says.
        */}
        <p className="auth-signup">New here? Continuing with GitHub or Google creates your archive.</p>
