...
pub static SOURCES: &[SourceSpec] = &[
    ...
    SourceSpec {
        ...
        stability: Stability::Internal,
        common_paths: NONE,
        linux_paths: &[".config/Code/User/globalStorage/saoudrizwan.claude-dev/tasks"],
        macos_paths: &[
            "Library/Application Support/Code/User/globalStorage/saoudrizwan.claude-dev/tasks",
        ],
        windows_paths: &["AppData/Roaming/Code/User/globalStorage/saoudrizwan.claude-dev/tasks"],
        environment_override: None,
    },
    SourceSpec {
        id: "roo",
    ...
    SourceSpec {
        ...
        tier: 3,
        format: "protobuf conversations",
        stability: Stability::ReverseEngineered,
        common_paths: &[".gemini/antigravity/conversations/*.pb"],
        linux_paths: NONE,
        macos_paths: NONE,
        windows_paths: NONE,
        environment_override: None,
    ...
    SourceSpec {
        ...
        tier: 3,
        format: "base state and event stream",
        stability: Stability::Internal,
        common_paths: &[".openhands/conversations/*"],
        linux_paths: NONE,
        macos_paths: NONE,
        windows_paths: NONE,
        environment_override: None,
    ...
    SourceSpec {
        ...
        stability: Stability::Internal,
        common_paths: &[".factory/sessions/*.jsonl"],
        linux_paths: NONE,
        macos_paths: NONE,
        windows_paths: NONE,
        environment_override: None,
    ...
    SourceSpec {
        ...
        format: "chat JSON",
        stability: Stability::Internal,
        common_paths: &[".qwen/tmp/*/chats/session-*.json"],
        linux_paths: NONE,
        macos_paths: NONE,
        windows_paths: NONE,
        environment_override: None,
    ...
    SourceSpec {
        ...
        common_paths: &[".aider.chat.history.md"],
        linux_paths: NONE,
        macos_paths: NONE,
        windows_paths: NONE,
        environment_override: None,
    ...
    SourceSpec {
        ...
        tier: 3,
        format: "typed-event JSONL",
        stability: Stability::Internal,
        common_paths: &[".pi/agent/sessions/*.jsonl"],
        linux_paths: NONE,
        macos_paths: NONE,
        windows_paths: NONE,
        environment_override: None,
    ...
    SourceSpec {
        ...
        format: "thread store",
        stability: Stability::ReverseEngineered,
        common_paths: &[".local/share/amp/threads"],
        linux_paths: NONE,
        macos_paths: &[
            "Library/Application Support/Code/User/globalStorage/sourcegraph.amp",
            "Library/Application Support/Code/User/workspaceStorage/*/sourcegraph.amp",
        ],
        windows_paths: &[
            "AppData/Roaming/Code/User/globalStorage/sourcegraph.amp",
            "AppData/Roaming/Code/User/workspaceStorage/*/sourcegraph.amp",
        ],
        environment_override: Some("AMP_DATA_DIR"),
    },
    SourceSpec {
        id: "warp",
        display_name: "Warp",
        ...
        stability: Stability::ReverseEngineered,
        common_paths: NONE,
        linux_paths: &[".local/state/warp-terminal/warp.sqlite"],
        macos_paths: &[
        ...
        windows_paths: &["AppData/Local/warp/Warp/data/warp.sqlite"],
        environment_override: Some("WARP_DB_PATH"),
    },
    SourceSpec {
        id: "windsurf",
        ...
        windows_paths: &[
            ...
            "AppData/Roaming/Windsurf/User/workspaceStorage/*/state.vscdb",
        ],
        environment_override: Some("WINDSURF_DATA_DIR"),
    },
];
